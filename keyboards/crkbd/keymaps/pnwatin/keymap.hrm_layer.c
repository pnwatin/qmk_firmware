...
// THUMBROW
// #define TRM_ESC LT(SYM, KC_ESC)
// #define TRM_SPC LT(NAV, KC_SPC)

// #define TRM_ENT LT(NUM, KC_ENT)
// #define TRM_BSPC LT(SYM, KC_BSPC)
...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  [BASE] = LAYOUT_split_3x6_3(
   ...
   //|--------+--------+--------+--------+--------+--------|                    |--------+--------+--------+--------+--------+--------|
       XXXXXXX,   HRM_Z,    KC_X,    KC_C,   HRM_D,    KC_V,                         KC_K,   HRM_H, KC_COMM,  KC_DOT, HRM_UND, XXXXXXX,
   //|--------+--------+--------+--------+--------+--------+--------|  |--------+--------+--------+--------+--------+--------+--------|
  ...
  [NAV] = LAYOUT_split_3x6_3(
   //,-----------------------------------------------------.                    ,-----------------------------------------------------.
       XXXXXXX, QK_BOOT, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX,                      KC_HOME, KC_PGDN, KC_PGUP,  KC_END, XXXXXXX, XXXXXXX,
   //|--------+--------+--------+--------+--------+--------|                    |--------+--------+--------+--------+--------+--------|
...
// const uint16_t os_shift[] PROGMEM = {HRM_T, HRM_N, COMBO_END};

combo_t key_combos[] = {
    COMBO(capsword, CW_TOGG),
    // COMBO(os_shift, OSM(MOD_LSFT)),
};
